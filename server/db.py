...
FACT_NAMES = [
    ...
    "mc_share",
    "dialysis_facility", "ipf_facility",
    ...
    "nas_rates", "pregnant_postpartum",
    "caa_fmap",
    "complications_hosp",
    "unplanned_visits_hosp",
    ...
    "medicare_enrollment", "cms_impact",
    "otp_provider", "cms64_ffcra", "contraceptive_care",
    "respiratory_conditions", "esrd_qip_tps",
    "program_monthly", "mc_annual",
    "chip_monthly", "chip_app_elig",
    "new_adult_enrollment", "drug_rebate_products",
    ...
    "aco_reach_results", "part_d_quarterly_spending",
    ...
    "mc_info_annual", "program_info_monthly",
    "bea_state_gdp", "bea_gdp_growth",
    "cdc_maternal_mortality_prov", "cdc_vsrr_vital",
    "mltss_enrollees", "hospital_general_info",
    "mc_annual_v2", "mc_features_population",
    ...
    "continuous_eligibility_v2",
    "medicaid_chip_eligibility_levels",
    ...
    "mdrp_drug_products_q4_2025",
    "dsh_reporting_latest",
    "medicaid_enterprise_system",
    ...
    "kff_1115_work_requirements",
    "state_mac_ny", "state_mac_tx",
    "nsduh_2022_state",
    # Section 1115 Medicaid waivers (665 waivers, 54 states)
    "section_1115_waivers", "kff_1115_waivers",
    # Session 22: SDUD historical combined (individual year tables removed, kept sdud_historical_combined)
    ...
    "natality_state_2023", "natality_by_payer_2023", "mcpar_detail",
    ...
    "nhe_medicaid_aggregate", "nhe_medicaid_per_enrollee", "nhe_medicaid_enrollment",
    "fmap_kff_historical",
