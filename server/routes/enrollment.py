...
async def eligibility(state_code: str):
    ...
    try:
        ...
        raise HTTPException(500, {"error": "Eligibility query failed", "detail": str(e)})
...
async def expansion_enrollment(state_code: str):
    ...
    try:
        ...
        raise HTTPException(500, {"error": "Expansion enrollment query failed", "detail": str(e)})
...
async def unwinding(state_code: str):
    ...
    try:
        ...
        raise HTTPException(500, {"error": "Unwinding query failed", "detail": str(e)})
...
async def managed_care_plans(state_code: str):
    ...
    try:
        ...
        raise HTTPException(500, {"error": "Managed care plans query failed", "detail": str(e)})
